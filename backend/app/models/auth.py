...
class AuthSettings(Base):
    ...
    saml_idp_certificate: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    saml_sp_entity_id: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    saml_display_name: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True, default="SAML"
    )
