...
export function EC2DetailPanel({ instance, onClose }: EC2DetailPanelProps) {
  return (
    <div className="fixed top-[calc(4rem+1px)] right-0 bottom-0 z-50 w-96 overflow-y-auto border-l border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800">
