...
export function NATGatewayDetailPanel({ natGateway, onClose }: NATGatewayDetailPanelProps) {
  return (
    <div className="fixed top-16 bottom-0 right-0 z-50 w-96 overflow-y-auto border-l border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800">
